          ...
          <TabsContent value="checkliste">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Alle wichtigen Aufgaben für Ihr Fest
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {checklist.map((item) => (
                    <div key={item.id} className="flex items-start space-x-3 p-4 border rounded-lg bg-card">
                      <Checkbox 
                        id={`task-${item.id}`}
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <div className="flex items-center text-xs text-muted-foreground space-x-4">
                          <span>Fällig: {new Date(item.due_date).toLocaleDateString('de-AT')}</span>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <Badge 
                              variant={resource.status === 'bestellt' ? 'secondary' : 'destructive'}
                            >
