...
const menuItems = [
	{ id: 1, name: 'Schnitzel', category: 'Essen', price: 12.5, icon: Utensils },
	{ id: 2, name: 'Bratwurst', category: 'Essen', price: 4.5, icon: Utensils },
	{ id: 3, name: 'Bier 0,5l', category: 'Getränke', price: 3.8, icon: Beer },
	{ id: 4, name: 'Radler 0,5l', category: 'Getränke', price: 3.8, icon: Beer },
	{ id: 5, name: 'Kaffee', category: 'Getränke', price: 2.2, icon: Coffee },
	{ id: 6, name: 'Apfelsaft', category: 'Getränke', price: 2.5, icon: Coffee }
];
...
export default function MobileWaiter() {
	...
	return (
		<div className="min-h-screen bg-background">
			...
			<div className="pt-16">
				{/* Header */}
				<div className="sticky top-16 bg-background border-b p-4 z-10">
